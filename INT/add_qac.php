                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
							...
							<li class="active"><a href="#">Add qac</a></li>
						</ol>
								...
								<div class="col-md-12">
									<div class="panel panel-primary">
										<div class="panel-heading ">
											<h2>ADD qac : Process Change Report System [<?phpecho $row_QAC_t["cta_name"]?>]</h2>
											<!-- <div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div> -->
										</div>
										<div class="panel-body">
											<form class="form-horizontal" action="../ENG/add_qac.php?id=<?phpecho $_GET["id"]?>" method="post" enctype="multipart/form-data" >
												<div class="form-group">
													<label for="focusedinput" class="col-sm-2 control-label">Employee ID :</label>
													<div class="col-sm-5">
														<input type="text" class="form-control" name="Emp_ID" id="appdepart_name0" placeholder="Employee ID" data-validation="required" data-validation-error-msg="Please enter employee id.">
													</div>
												</div>
												<div class="form-group">
													<label for="focusedinput" class="col-sm-2 control-label">Name - Surname :</label>
													<div class="col-sm-5">
														<input type="text" class="form-control" disabled name="password" id="appdepart_Position0" placeholder="Name - Surname">
													</div>
												</div>
												<div class="form-group">
													<label for="focusedinput" class="col-sm-2 control-label">Position/Department :</label>
													<div class="col-sm-5">
														<input type="text" class="form-control" disabled id="appdepart_department0" name="Con_password" placeholder="Position/Department" >
													</div>
												</div>
												<div class="form-group">
													<label for="focusedinput" class="col-sm-2 control-label">Level :</label>
													<div class="col-sm-5">
														<select class="form-control" name="level" data-validation="number" data-validation-error-msg="Please select">
															<option value="">Select</option>
															<?php
															for($i=1;$i<=10;$i++){
																$sql_t = "SELECT * FROM pcr_qac_approver WHERE qca_cta_id = '".$_GET["id"]."' AND qca_level = '".$i."'";
												...
												<div class="form-group">
													...
													<div class="col-sm-5">
														<input type="text" class="form-control" disabled id="appdepart_department0" name="Con_password" value="<?phpecho $row_QAC_t["cta_name"]?>" >
													</div>
												</div>
