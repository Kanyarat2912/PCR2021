								...
								<div class="col-md-12">
									<div class="panel panel-primary " data-widget='{"id" : "wiget9", "draggable": "false"}'>
										...
										<div class="panel-body">
											<form class="form-horizontal" action="../ENG/change_password_sys.php?Emp_ID=<?php echo $_SESSION["empid_pcr"]?>" method="post" enctype="multipart/form-data" >
												<div class="form-group">
													<label for="focusedinput" class="col-sm-2 control-label">Employee ID :</label>
													<div class="col-sm-5">
														<input type="text" class="form-control" readOnly value="<?php echo $_SESSION["empid_pcr"]?>" id="focusedinput" placeholder="Employee ID">
													</div>
												</div>
												<div class="form-group">
