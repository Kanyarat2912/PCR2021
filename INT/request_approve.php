...
<div id="wrapper">
            ...
            <div class="static-content">
                <div class="page-content">
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="#">Request PCR</a></li>
					</ol>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body no-padding">
									<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										<tbody>
											<?php   echo Select_Request_PCR($conn, $condbmc); ?>
										</tbody>
									</table>
								</div>
								<!-- panel footer -->
	...
	<div id="CancelModal" class="modal animated bounceIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<!-- dialog -->
		...
		<div class="modal-content">
			...
			<!-- body -->
		<form class="grid-form" action="../ENG/cancel_approve_access.php" method="post" enctype="multipart/form-data">
					...
					<div class="panel panel-transparent" data-widget="{"draggable": "false"}">
						<div class="panel-body">
							...
							<h1 class="modal-title">
								<center>Would you like to cancel approve PCR?</center>
							</h1>
	...
	<!-- <script type="text/javascript">
		$(function() {
			...
			$("#pcr_number_submit").click(function(e) {
				...
				// Add data:
				addHidden(theForm, 'condition', 'cancel_request_pcr');
