            ...
            <div class="static-content">
                <div class="page-content">
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="app_dept.php">My Pending</a></li>
					</ol>
								...
								WHILE($row_MY_PCR = mysqli_fetch_array($result_MY_PCR)){
									...
									if($row_flow["ap_emp_code"] == $_SESSION["empid_pcr"] AND $row_flow["ap_apr_id"] <= 2){
										if($row_MY_PCR["fm_phase"] == 1){
											$link = "Approver_department.php";
										}else if($row_MY_PCR["fm_phase"] == 2){
											$link = "Approver_department_result.php";
										}
										echo '<form action="../ENG/'.$link.'?step='.$row_MY_PCR["fm_state_app"].'&PCR='.$row_MY_PCR["fm_pcr_number"].'" method="post">';
