...
if($_SESSION["empid_pcr"] == ""){
	...
	$sql_implementation = "SELECT mf_date_plan,mf_date_result FROM pcr_implement_form WHERE mf_fm_id = '".$pcr_number."' ORDER BY mf_im_id ASC";
	...
	WHILE($row_implementation = mysqli_fetch_array($query_implementation)){
		...
		$implementation2[$i] = $row_implementation["mf_date_result"];
		$i++;
	}
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
							...
							<li class="active"><a href="form-gridforms.html">Form Reject</a></li>
						</ol>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-primary">
										...
										<?php
										if($row_pcr["checkk"] == 2){
											$sql_RJ = "SELECT * FROM pcr_reject WHERE pcr_id = '".$pcr_number."' AND status = 0 AND fh = 2 ";
										...
										?>
											<form class="grid-form" action="../ENG/RJ_Result.php?pcr_number=<?phpecho $pcr_number?>" method="post" enctype="multipart/form-data" >
												<fieldset>
												...
												<fieldset>
													...
													<div class="form-group">
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															...
															<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><b><u>[Plan]</u></b></center>
														</label>
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<center><b><u>[Actual/Before]</u></b></center>
														</label>
														<label class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<center><b><u>[Actual/After]</u></b></center>
														</label>
													</div>
													<br>
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[0]))?></center>
														</label>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[1]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[2]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[3]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[4]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd">
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[5]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[6]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?phpecho date("d-M-yy", strtotime($implementation2[7]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
												...
												<fieldset>
													...
													if($row_attach_doc["att_pfmea"] != ""){
														echo '<div class="form-group">';
															...
															echo '<label class="col-sm-3 col-xs-3 col-md-3 col-lg-3 ">';
																echo '<input class="form-control" name="PFMEA" value="'.$row_attach_doc["att_pfmea"].'" placeholder="Document Number" required />';
															echo '</label>';
														echo '</div>';
														echo '<br>';
														$i++;
													...
													if($row_attach_doc["att_qa_network"] != ""){
														echo '<div class="form-group">';
															...
															echo '<label class="col-sm-3 col-xs-3 col-md-3 col-lg-3 ">';
																echo '<input class="form-control" name="qa" value="'.$row_attach_doc["att_qa_network"].'" placeholder="Document Number" required />';
															echo '</label>';
														echo '</div>';
														echo '<br>';
														$i++;
													...
													if($row_attach_doc["att_control_plan"] != ""){
														echo '<div class="form-group">';
															...
															echo '<label class="col-sm-3 col-xs-3 col-md-3 col-lg-3 ">';
																echo '<input class="form-control" name="Control" value="'.$row_attach_doc["att_control_plan"].'" placeholder="Document Number" required />';
															echo '</label>';
														echo '</div>';
														echo '<br>';
														$i++;
