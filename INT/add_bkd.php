                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
							...
							<li class="active"><a href="#">Add QA Audit</a></li>
						</ol>
								...
								<div class="col-md-12">
									<div class="panel panel-primary">
										<div class="panel-heading ">
											<h2>ADD QA Audit : Process Change Report System</h2>
											<!-- <div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div> -->
										</div>
										<div class="panel-body">
											<form class="form-horizontal" action="../ENG/add_bkd.php" method="post" enctype="multipart/form-data" >
