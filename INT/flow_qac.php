            ...
            <div class="static-content">
                <div class="page-content">
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="#">Flow Approve QA Check</a></li>
					</ol>
								...
								<div class="panel-body no-padding">
									<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										<tbody>
											<?php
											$i = 1;
											$sql_QAC = "SELECT * FROM pcr_qac_type_approve";
											$result_QAC = mysqli_query($conn, $sql_QAC);
											WHILE($row_QAC = mysqli_fetch_array($result_QAC)){
												echo '<tr class="odd gradeX">';
													echo '<td><center>'.$i.'</center></td>';
													echo '<td>'.$row_QAC["cta_name"].'</td>';
													echo '<td><center>';
													echo '<a href="flow_qac_d.php?id='.$row_QAC["cta_id"].'"" class="btn btn-warning-alt"><i class="ti ti-pencil"></i></a>';
													echo '</center></td>';
												echo '</tr>';
												$i++;
											}
