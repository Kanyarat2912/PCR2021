...
<div id="wrapper">
	...
	<div class="static-content-wrapper">
		...
		<form action="../ENG/Approver_bkd.php?step=<?phpecho $row_pcr["fm_state_app"]?>&PCR=<?phpecho $pcr_number?>" method="post">
			...
			<div class="modal-dialog">
				<div class="modal-content" >
					<div class="modal-header" style="background-color:#00bfbf;">
						...
						<h3 class="modal-title" id="myModalLabel"><b style="color:#ffffff;">Input Form QA Audit</b></h3>
					</div>
							...
							<div class="col-sm-12 col-xs-12 col-md-12col-lg-12">
									<div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
										<label class="radio-inline icheck" >
											<input type="radio" name="Requies" value="1">Requires
										</label>
									</div>
									<div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
										<label class="radio-inline icheck" >
											<input type="radio" name="Requies" value="0"> Not Requires
										</label>
									</div>
							</div>
							<br>
