...
$sql_ne = "SELECT * FROM employee WHERE Emp_ID = '".$emp_code."';";
$result_ne = mysqli_query($condbmc, $sql_ne);
$row_ne = mysqli_fetch_array($result_ne);
$name_r = $row_ne["Empname_engTitle"]." ".$row_ne["Empname_eng"]." ".$row_ne["Empsurname_eng"];
...
$strSubject = "PCR Result “Rejected” No.<".$number_pcr.">";
...
$strMessage = "
	...
	<br>
	<p>Reject by. [".$name_r."]</p>
	<p>[Comment]</p>
	<p><font color='red'>- ".$Comment_reject_dep."</font></p>
	<br>
